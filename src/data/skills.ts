...
export const SKILLS: Skill[] = [
  ...
  { name: 'Angular', category: 'frontend', level: 75, icon: SiAngular, color: '#DD0031' },
  ...
  { name: 'Express', category: 'backend', level: 72, icon: SiExpress, color: '#ffffff' },
  ...
  { name: 'MongoDB', category: 'database', level: 65, icon: SiMongodb, color: '#47A248' },
  ...
  { name: 'Figma', category: 'tools', level: 70, icon: SiFigma, color: '#F24E1E' },
  { name: 'Linux', category: 'tools', level: 75, icon: SiLinux, color: '#FCC624' },

  // Cloud
  { name: 'AWS', category: 'cloud', level: 60, icon: FaAws, color: '#FF9900' },
  { name: 'Azure', category: 'cloud', level: 55, icon: VscAzure, color: '#0078D4' },
  { name: 'Vercel', category: 'cloud', level: 82, icon: SiVercel, color: '#ffffff' },
  { name: 'Nginx', category: 'cloud', level: 60, icon: SiNginx, color: '#009639' },
];
